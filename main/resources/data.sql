...
insert into Match (id, teama_id, teamb_id) values (1, 300, 500);
insert into Match (id, teama_id, teamb_id) values (2, 200, 600);
insert into Match (id, teama_id, teamb_id) values (3, 100, 700);
insert into Match (id, teama_id, teamb_id) values (4, 400, 600);
insert into Match (id, teama_id, teamb_id) values (5, 600, 200);
insert into Match (id, teama_id, teamb_id) values (6, 700, 400);
insert into Match (id, teama_id, teamb_id) values (7, 800, 300);
insert into Match (id, teama_id, teamb_id) values (8, 500, 100);
